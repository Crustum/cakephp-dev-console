...
use Crustum\DevConsole\DevConsolePlugin;
...
Configure::write('Security', [
    'salt' => 'dev-console-test-security-salt-change-me',
]);
...
Cache::setConfig('_cake_translations_', [
    ...
    'prefix' => 'dev_console_test_translations_',
    'serialize' => true,
    'duration' => '+10 seconds',
]);
Cache::setConfig('_cake_model_', [
    'className' => 'File',
    'path' => CACHE . 'models/',
    'prefix' => 'dev_console_test_model_',
    'serialize' => true,
    'duration' => '+10 seconds',
]);
...
Plugin::getCollection()->add(new DevConsolePlugin([
